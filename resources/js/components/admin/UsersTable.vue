...
export default {
    ...
    methods: {
        ...
        async registerAccount(user) {
            await axios
                .post("http://35.78.89.60:80register", user)
                .then((res) => {
                    if (res.status === 200) {
                        Vue.$toast.open({
        ...
        async editUser(user) {
            await axios
                .put("http://35.78.89.60:80user/" + user.id, user)
                .then((res) => {
                    if (res.status === 200) {
                        Vue.$toast.open({
            ...
            if (this.resetPassword === "true") {
                await axios
                    .post("http://35.78.89.60:80reset-password/" + user.id)
                    .then((res) => {
                        if (res.status === 200) {
        ...
        async deleteUsers(user) {
            await axios
                .delete("http://35.78.89.60:80user/" + user.id, user)
                .then((res) => {
                    if (res.status === 200) {
                        Vue.$toast.open({
